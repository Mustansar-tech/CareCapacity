              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6">
                ...
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm font-medium flex items-center gap-2">
                    ...
                    <span className="text-gray-700 dark:text-gray-300">Total Desired Hours</span>
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="text-3xl font-bold bg-gradient-to-r from-green-600 to-green-800 bg-clip-text text-transparent mb-1" data-testid="text-desired-hours-sum">
                    {(filteredData || processedData)?.kpis.netCapacitySum}h
                  </div>
                  <div className="text-xs text-gray-500 dark:text-gray-400">Weekly capacity</div>
                </CardContent>
              </Card>
