...
--> statement-breakpoint
ALTER TABLE "branch_uploads" ADD CONSTRAINT "branch_uploads_branch_id_branches_id_fk" FOREIGN KEY ("branch_id") REFERENCES "public"."branches"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "branch_upload_branch_idx" ON "branch_uploads" USING btree ("branch_id");--> statement-breakpoint
CREATE INDEX "upload_uploaded_at_idx" ON "branch_uploads" USING btree ("uploaded_at");--> statement-breakpoint
