...
- **Strict Travel Time Limits:** Enforces a **strict 23-minute maximum travel time for all transport modes** to ensure fair scheduling and reduce mileage. Visits requiring longer travel are left unassigned for manual review rather than creating unfair routes.
